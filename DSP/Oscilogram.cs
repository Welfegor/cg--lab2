...
namespace Lab2
{
    public partial class Oscilogram : Form
    {
        string[] array;
        Bitmap[] bbb;
        ...
        public Oscilogram(string[] arr)
        {
            ...
            foreach (var scrn in Screen.AllScreens)
            {
                ...
                {
                    Location = new Point(scrn.Bounds.Right - Width, scrn.Bounds.Top + 50);
                    return;
                }
            }
        }
        ...
        private void Form2_Load(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < ChannelsNumber; i++)
            {
                ...
                float x = 120;
                float y = this.ClientSize.Height / ChannelsNumber - 25;
                ...
                MapRectangles(graphicsObj,
                    ...
                    0, this.ClientSize.Width, this.ClientSize.Height / ChannelsNumber - 25, 0);
        ...
        private void Form2_Paint(object sender, PaintEventArgs e)
        {
            ...
            foreach (Bitmap bmap in bbb)
            {
                ...
                graphicsObj.DrawRectangle(Pens.Black, 0, bmap.Height * h, bmap.Width, bmap.Height);
                h++;
            }
