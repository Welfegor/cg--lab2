...
namespace Lab2
{
    public partial class ChannelsInfo : Form
    {
        int ChannelsNumber;
        int SamplesNumber;
        float SamplingRate;
        ...
        public ChannelsInfo(int ChannelsNumber_, int SamplesNumber_, float SamplingRate_, string StartDate_,
        ...
        private void Form3_Load(object sender, EventArgs e)
        {
            ...
            filename = filename.Replace("C:\\Users\\Welfe\\Documents\\University\\Homework\\4\\КГ\\Данные\\", "");
